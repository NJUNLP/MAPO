...
accelerate launch --config_file="/mnt/data/shesj/RL4CoT/PPO/deepspeed_zero2_dpo.yaml" --num_processes 8 dpo.py --training_config $CONFIG > /mnt/data/shesj/print_log/$1
